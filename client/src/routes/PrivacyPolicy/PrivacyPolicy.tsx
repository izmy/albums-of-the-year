...
export const PrivacyPolicy: React.FC = () => {
  return (
    <Container>
      <h1>
        Privacy Policy of the "musicserver - Albums of the year" Facebook app
      </h1>
      ...
      <p>
        ...
        privacy policy or by dedicated explanation text contextually with the
        Data collection.
      </p>
      ...
      <p>
        ...
        the purposes indicated. In addition to the Data Controller, in some
        cases, the Data may be accessible to certain types of persons in charge,
        involved with the operation of the site (administration, sales,
      ...
      <p>
        The Data is processed at the Data Controller's operating offices and in
        any other places where the parties involved with the processing are
      ...
      <p>
        ...
        the User can always request that the Data Controller suspend or remove
        the data.
      </p>
      ...
      <p>
        ...
        Friends, are also available. If the user has made more of their data
      ...
      <p>
        ...
        has been stored and can consult the Data Controller to learn about their
        contents and origin, to verify their accuracy or to ask for them to be
      ...
      <p>
        ...
        the last modification listed at the bottom. If a User objects to any of
        the changes to the Policy, the User must cease using this Application
        and can request that the Data Controller removes the Personal Data.
        Unless stated otherwise, the then-current privacy policy applies to all
      ...
      <p>
        ...
        from our primary production servers. You own your data. Anytime you want
        your data removed from our system, you can request us to delete your
        account from our production servers by contacting on e-mail
        izmy(at)seznam.cz. As a result, your data will be excised permanently
        from our production servers and further access to your account will be
        impossible.
      </p>
      ...
      <p>
        ...
        starting from the modules provided by Iubenda and hosted on Iubenda's
        servers.
      </p>
      ...
      <p>
        ...
        addresses or domain names of the computers utilized by the Users who use
        this Application, the URI addresses (Uniform Resource Identifier), the
        ...
        visit (e.g., the time spent on each page within the Application) and the
        details about the path followed within the Application with special
        reference to the sequence of pages visited, and other parameters about
      ...
      <p>
        ...
        the methods of processing of Personal Data and the means used, including
        the security measures concerning the operation and use of this
        Application. The Data Controller, unless otherwise specified, is the
