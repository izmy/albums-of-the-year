        ...
        <>
          <ResultsVotersTable
            ...
            votes={
              usersVotes
                ...
                ?.votes.find((votes) => votes.type === "nomination-global-2023")
                ?.votes ?? []
            }
          />
          ...
          <ResultsVotersTable
            ...
            votes={
              usersVotes
                ?.find((usersVotes) => usersVotes.user === selectedUser)
                ?.votes.find((votes) => votes.type === "global-2023")?.votes ??
              []
            }
          />
          ...
          <ResultsVotersTable
            ...
            votes={
              usersVotes
                ?.find((usersVotes) => usersVotes.user === selectedUser)
                ?.votes.find((votes) => votes.type === "nomination-czech-2023")
                ?.votes ?? []
            }
          />
          ...
          <ResultsVotersTable
            ...
            votes={
              usersVotes
                ?.find((usersVotes) => usersVotes.user === selectedUser)
                ?.votes.find((votes) => votes.type === "czech-2023")?.votes ??
              []
            }
          />
        </>
