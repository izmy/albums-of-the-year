...
export const nominationChartsParameters: ChartParameters[] = [
  { title: "Zahraniční alba", type: "nomination-global-2021", size: 40 },
  { title: "Česká alba", type: "nomination-czech-2021", size: 20 },
];

export const chartsParameters: ChartParameters[] = [
  { title: "Zahraniční alba", type: "global-2021", size: 40 },
  { title: "Česká alba", type: "czech-2021", size: 20 },
];
